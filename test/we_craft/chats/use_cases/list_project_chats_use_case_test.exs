defmodule WeCraft.Chats.UseCases.ListProjectChatsUseCaseTest do
  ...
  describe "list_project_chats/1" do
    setup do
      ...
      main_chat = create_chat(%{project_id: project1.id, is_main: true})
      secondary_chat = create_chat(%{project_id: project1.id, is_main: false})
      ...
      other_chat = create_chat(%{project_id: project2.id, is_main: true})
