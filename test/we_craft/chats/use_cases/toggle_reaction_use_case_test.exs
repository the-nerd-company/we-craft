defmodule WeCraft.Chats.UseCases.ToggleReactionUseCaseTest do
  ...
  alias WeCraft.Chats.UseCases.ToggleReactionUseCase
  ...
  describe "toggle_reaction/1" do
    test "adds reaction if it doesn't exist" do
      ...
      assert {:ok, updated_message} = ToggleReactionUseCase.toggle_reaction(params)
    ...
    test "removes entire reaction when last user is removed" do
      ...
      assert {:ok, final_message} = ToggleReactionUseCase.toggle_reaction(params)
    ...
    test "returns error for non-existent message" do
      ...
      assert {:error, :message_not_found} = ToggleReactionUseCase.toggle_reaction(params)
    end
